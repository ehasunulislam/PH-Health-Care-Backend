...
import { AppointmentStatus, DoctorVerificaitonStatus, PaymentStatus, ScheduleStaus } from "../../../generated/prisma/enums";
...
const getAdminAnalytics = async () => {
    ...
    const totalPendingDoctorApplications = await prisma.doctor.count({
        where: {
            isDeleted: false,
            verificationStatus : DoctorVerificaitonStatus.PENDING
        }
    })
