...
*/
-- CreateEnum
CREATE TYPE "ScheduleStaus" AS ENUM ('DRAFT', 'PUBLISHED');
...
CREATE TABLE "schedules" (
    ...
    "staus" "ScheduleStaus" NOT NULL DEFAULT 'DRAFT',
...
-- AddForeignKey
ALTER TABLE "schedules" ADD CONSTRAINT "schedules_doctorId_fkey" FOREIGN KEY ("doctorId") REFERENCES "doctor"("id") ON DELETE CASCADE ON UPDATE CASCADE;
